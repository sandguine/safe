...
def run_baseline_experiment(cycles: int = 10, 
                          max_puzzles_per_cycle: int = 8) -> MetricsCollector:
...
def run_oversight_experiment(cycles: int = 10, 
                           max_puzzles_per_cycle: int = 8) -> MetricsCollector:
...
def main():
    ...
    # Configuration
    cycles = 10
    max_puzzles_per_cycle = 8
    
    print(f"Configuration:")
    print(f"  Cycles per experiment: {cycles}")
    print(f"  Max puzzles per cycle: {max_puzzles_per_cycle}")
    ...
    try:
        ...
        baseline_metrics = run_baseline_experiment(cycles, max_puzzles_per_cycle)
        
        # Run oversight experiment
        oversight_metrics = run_oversight_experiment(cycles, max_puzzles_per_cycle)
        ...
        # Save results
        save_results(baseline_metrics, oversight_metrics, comparison_report)
