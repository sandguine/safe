...
class EnhancedAZRLoop:
    ...
    def _calculate_cycle_metrics(self, humaneval_results: Dict[str, Any]) -> Dict[str, float]:
    ...
    def _save_final_results(self, final_results: Dict[str, Any]):
        ...
        with open(csv_file, 'w') as f:
            ...
            for cycle_key, cycle_data in self.results.items():
                ...
                avg_ratio = cycle_data['metrics']['avg_ratio_n4']  # Use n=4 as representative
                duration = cycle_data['duration']
                
                f.write(f"{cycle_num},{best_pass_at_1:.4f},{avg_ratio:.4f},{duration:.2f}\n")
